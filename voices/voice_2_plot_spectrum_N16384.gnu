...
# Usage: gnuplot -persist voice_2_plot_spectrum_N16384.gnu
set encoding utf8
set datafile separator ','
set title 'Spectrum (voice_2_spectrum_N16384.csv)  N=16384'
...
plot 'voice_2_spectrum_N16384.csv' using 1:2 with lines title 'magnitude (N=16384)'
