...
# Usage: gnuplot -persist voice_2_plot_spectrum_N4096.gnu
set encoding utf8
set datafile separator ','
set title 'Spectrum (voice_2_spectrum_N4096.csv)  N=4096'
...
plot 'voice_2_spectrum_N4096.csv' using 1:2 with lines title 'magnitude (N=4096)'
