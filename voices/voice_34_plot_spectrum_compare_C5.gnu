# voice_34_plot_spectrum_compare_C5.gnu
# Usage: gnuplot -persist voice_34_plot_spectrum_compare_C5.gnu
...
plot 'voice_34_spectrum_N4096.csv' using 1:2 with linespoints pt 7 ps 0.5 title 'N=4096 (df=11.718750Hz)', \
     'voice_34_spectrum_N16384.csv' using 1:2 with linespoints pt 7 ps 0.5 title 'N=16384 (df=2.929688Hz)'
